...
```json
{
  "projectName" : "tanzu-java-web-app-kevinvmware",
  "repositoryPrefix" : "https://registry.lab.livefire.dev/harbor/projects/6/repositories"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->tanzu-java-web-app-k...(truncated)]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].merge.transformations[0].sources[1].<combo>.transformations[1].transformations[1] (ReplaceText)
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [your-registry.io/project->https://registry.lab...(truncated)]
